...
public static class BackendRuntimeSnapshotViewHelper
{
    ...
    [
        ...
        nameof(MainViewModel.LatestTurnState),
        nameof(MainViewModel.LatestTurnHeadlineText),
        nameof(MainViewModel.LatestTurnSummaryText),
        nameof(MainViewModel.LatestTurnCapabilitiesText),
        nameof(MainViewModel.LatestTurnReasonText),
        nameof(MainViewModel.LatestTurnOutcomeText),
        nameof(MainViewModel.LatestTurnActionLabel),
        nameof(MainViewModel.LatestTurnActionKey),
